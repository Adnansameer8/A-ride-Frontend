  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f9fafb", padding: "24px", fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: "24px", flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h1 style={{ fontSize: "30px", fontWeight: "900", color: "#111827", margin: "0 0 8px", fontFamily: "'Sekuya', sans-serif", letterSpacing: '1px' }}>SUPPORT TICKETS</h1>
          <p style={{ fontFamily: "'outline',san-serif", fontSize: "20px", fontWeight: "500", margin: 0 }}>Review, respond, and manage customer support requests.</p>
        </div>
